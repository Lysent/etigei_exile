...
extend(ForceProjector, "shielded-etgwall-big", {});
extend(MendProjector, "etigeum-mend-wall", {});
...
// Neoulandia
extend(CoreBlock, "colony-core", {});
extend(Drill, "mini-drill", {});
extend(Drill, "middle-drill", {});
extend(UnitCargoLoader, "loading-docks", {});
...
extend(ItemTurret, "parapet", {});
extend(ItemTurret, "tour", {});
extend(UnitFactory, "civil-manufactory", {});
extend(UnitFactory, "land-manufactory", {});
extend(UnitFactory, "air-manufactory", {});
extend(Wall, "barrier", {});
extend(Wall, "barrier-big", {});
extend(Wall, "hesco", {});
extend(Wall, "hesco-big", {});